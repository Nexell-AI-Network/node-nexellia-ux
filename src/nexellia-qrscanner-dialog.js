...
class NexelliaQRScannerDialog extends NexelliaDialog{
	...
	static get styles(){
		return [NexelliaDialog.styles, css`
			.container{
				...
				max-height:var(--nexellia-dialog-container-max-height, 620px);
			}
...
NexelliaQRScannerDialog.define("nexellia-qrscanner-dialog");
