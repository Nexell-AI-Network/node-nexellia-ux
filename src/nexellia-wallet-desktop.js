import {html, css, FlowFormat, i18n, T} from './nexellia-wallet-ui.js';
import {NexelliaWalletMobile} from './nexellia-wallet-mobile.js';

export class NexelliaWalletDesktop extends NexelliaWalletMobile{
	...
	static get styles(){
		return [NexelliaWalletMobile.styles, css`
			:host{overflow:hidden}
			.container{
				padding:var(--nexellia-wallet-container-padding, 15px);
			...
			.wallet-warning{
				...
				background-color:var(--nexellia-wallet-warning-bg, #fdf8e4);
			}
			...
			.right-area{
				...
				height:var(--nexellia-wallet-right-area-height, calc(100vh - 122px));
			...
			.top-menu{
				...
				position:var(--nexellia-wallet-top-menu-position, absolute);
				right:var(--nexellia-wallet-top-menu-right, 20px);
				top:var(--nexellia-wallet-top-menu-top, -4px);
				z-index:2;
			...
			.header{
				border-bottom:var(--nexellia-wallet-header-border-bottom, --2px solid var(--nexellia-wallet-tab-border-top-color, var(--flow-primary-color)));
			}
		`];
	}
	constructor() {
