import {
	html, css, NexelliaDialog, T, NXL,
	formatForMachine, formatForHuman
} from './nexellia-dialog.js';

class NexelliaReceiveDialogMobile extends NexelliaDialog{
...
NexelliaReceiveDialogMobile.define("nexellia-receive-dialog-mobile");
