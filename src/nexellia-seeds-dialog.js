import {
	html, css, NexelliaDialog, chunks, getRandomInt, shuffle,
	T, i18n
} from './nexellia-dialog.js';

class NexelliaSeedsDialog extends NexelliaDialog{
	...
	static get styles(){
		return [NexelliaDialog.styles, css`
			...
			.container{max-height:var(--nexellia-dialog-container-max-height, 660px)}
...
NexelliaSeedsDialog.define("nexellia-seeds-dialog");
